...
class MatricesTest {
  ...
  void rotate() {
    ...
    assertArrayEquals(Expected1, Matrices.rotate(Input1));
    assertArrayEquals(Expected2, Matrices.rotate(Input2));
    assertArrayEquals(Expected3, Matrices.rotate(Input3));
